...
# Simple Ray Tracing with Diffuse and Specular Reflection
...
scene = [
    Sphere((0, -1, 3), 1, (255, 0, 0), 500),  # Red
    Sphere((2, 0, 4), 1, (0, 0, 255), 500),  # Blue
    Sphere((-2, 0, 4), 1, (0, 255, 0), 10),  # Green
...
# Calculate lighting at a point, including diffuse and specular reflections
...
# Trace a ray and return the color of the closest sphere with lighting and specular reflection
...
image.save("ray_traced_scene_with_specular.png")